...
检验和：检验和是为了提供可靠的 UDP 首部和数据而设计，这里不要和上面的不可靠传输搞混淆了，这里提供可靠的 UDP 首部，是因为一个进程可能接受多个进程过来的报文，那么如何区分他们呢，
...
![img](./picture/999804-20170929140236606-834864575.png)　　　　　**![img](./picture/999804-20170929140445825-702107298.png)**
